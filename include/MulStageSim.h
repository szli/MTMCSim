#ifndef _MULSTAGESIM_H_INCLUDED
#define _MULSTAGESIM_H_INCLUDED
...
class MulStageSim: public MTMCSimBase{
public:
	...
	*/
	...
	MulStageSim(MulStagePara& para_, TextSaveUI& resFile_, TextSaveUI& tempFile_, DispUI& dispUI_);
