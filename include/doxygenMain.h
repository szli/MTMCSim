...
*	Author: Shizheng Li, Dept. of Electrical and Computer Engineering, Iowa State University
*
*	Contact: szli AT iastate.edu
*
*	Important note: The current documentation contains information on unpublished research work.
*	This documentation is not availbe to general public. Please do not disclose  
*	this documentation to other people.
*
*	All rights reserved. Copyright (c) 2010 Shizheng Li

(This project may be opensource in the future.)
*	
...
*	
*	The project requires Boost library. Tested under 1.43 and 1.44 version. Boost::thread must be built on the system. 
*
...
future but this should be done carefully to avoid any possible correlation between RN sequences. 
...
in this project are boost::shared_ptr. All containers are from C++ STL. 
	...
	In this project, we call a bunch of data that gives one sample output to be a frame. In Monte Carlo simulation, we simulation 
...
*	change the display and save format easily. 
*
